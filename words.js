...
const WORD_GRADES = {
  2: [
    "ACORN", "AFTER", "AGAIN", "ALIVE", "ALONE", "ALONG", "ANGEL",
    "ANGRY", "APPLE", "ARROW", "ATTIC", "AWAKE", "AWFUL",
    "BACON", "BAGEL", "BEACH", "BENCH", "BERRY",
    "BLACK", "BLANK", "BLIND", "BLOCK", "BLOOM", "BLOWN", "BOARD",
    "BRAVE", "BREAD", "BREAK", "BRICK", "BRING", "BROOM", "BROWN",
    "BRUSH", "BUDDY", "BUILD", "BUILT", "BUNCH", "BUNNY", "BURST",
    "CABIN", "CAMEL", "CANDY", "CANOE", "CARRY", "CATCH",
    "CHAIR", "CHALK", "CHASE", "CHECK", "CHEER", "CHEST", "CHICK",
    ...
    "FLAME", "FLASH", "FLOCK", "FLOOD", "FLOOR", "FLOSS", "FLOUR",
    "FLUTE", "FOGGY", "FORCE", "FOUND", "FRESH", "FROZE", "FRUIT", "FUNNY",
    "FUZZY",
    "GIANT", "GIVEN", "GLASS", "GLOBE", "GLOVE", "GOING", "GRADE",
    "GRAND", "GRAPE", "GRASS", "GREAT", "GREEN", "GRILL", "GROUP", "GROWL",
    "GROWN", "GUARD", "GUIDE",
    "HANDY", "HAPPY", "HEART", "HEAVY", "HELLO", "HIPPO",
    "HOBBY", "HOLLY", "HONEY", "HORSE", "HOTEL", "HOUSE",
    "HUMAN", "HUMOR",
    ...
    "MIGHT", "MONEY", "MONTH", "MOODY", "MOSSY", "MOUNT",
    "MOUSE", "MOVIE", "MUDDY", "MUNCH", "MUSIC",
    "NIGHT", "NINJA", "NORTH", "NURSE",
    "OCEAN", "OFFER", "OFTEN", "OLIVE", "ONION", "ORDER", "OTHER", "OTTER",
    "OUTER", "OWNER",
    "PAINT", "PANDA", "PAPER", "PARTY", "PATCH", "PEACE", "PEACH",
    ...
    "ROBIN", "ROCKY", "ROUND", "ROYAL", "RULER",
    "SADLY", "SALAD", "SALTY", "SANDY", "SAUCE", "SCARY", "SCOUT",
    "SEVEN", "SHADE", "SHAPE", "SHARK", "SHARP", "SHEEP", "SHELF",
    "SHELL", "SHIFT", "SHINE", "SHIRT", "SHOOT", "SHORT", "SHOUT",
    ...
    "START", "STATE", "STEAL", "STEAM", "STICK", "STILL", "STONE",
